...
(4) Der Bargeldbestand muss angemessen (maximal 1.000,00 Euro) und versichert sein. Notwendige kurzfristige höhere Bargeldbestände (zum Beispiel vor und nach Veranstaltungen) sind in ihrer Höhe und Dauer (maximal vier Wochen) auf ein Minimum zu begrenzen.
...
(5) Die in Absatz 1 benannten Personen beurkunden die Kenntnisse dieser Ordnung mit einer Unterschrift gegenüber dem Studierendenparlament. Wird ein unter Absatz 1 genannter Posten neu besetzt, wird die Beibringung der Kenntnis innerhalb von vier Wochen oder bis zur nächsten ordentlichen Sitzung des Studierendenparlaments fällig, je nachdem, welche Frist später endet.
